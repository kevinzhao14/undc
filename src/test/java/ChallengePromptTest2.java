...
public class ChallengePromptTest2 extends ApplicationTest {
    ...
    public void testPopupButtons() {
        ...
        FxAssert.verifyThat(new Button("Proceed"), NodeMatchers.isNotNull());
        FxAssert.verifyThat(new Button("Leave"), NodeMatchers.isNotNull());
    }
}
